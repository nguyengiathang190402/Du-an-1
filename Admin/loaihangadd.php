<?php
///code thêm sp
if (isset($_POST['them-loaihang'])) {
    $ten_loai =$_POST['ten_loai'];
   $connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
   $query = "insert into danhmuc (ten_loai) values('$ten_loai')";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <span class="input-group-text" id="basic-addon1">Tên Loại</span>
                    <input class="form-control" type="text" name="ten_loai" placeholder="tên loại hàng">
                </div>
            </div>
        ...
        <div class="form-group">
            <button class="btn btn-primary pl"name="them-loaihang">Thêm Mới</button>
