                        ...
                        <div class="col-xl-12">
                            ...
                            <h5 class=""> Danh sách tài khoản </h5>
                                <div class="card-header py-3 bg-transparent">
                                    <button class="btn btn-success btns"><a href="taikhoanadd.php">Thêm</a></button>
                                    ...
                                    <table class="table table-success table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($tai_khoan as $item) : ?>
                                                <tr>
                                                    <td><?php echo $item['ma_tk'] ?></td>
                                                    <td><?php echo $item['ten_tk'] ?></td>
                                                    
                                                    <td><?php echo $item['email']; ?></td>
                                                    <td><?php echo $item['vai_tro'] ?></td>
                                                    <td><?php echo $item['dia_chi']; ?></td>
                                                    <td><img style="width: 30px;" src="<?php echo $item['anh'] ?>" alt=""></td>
                                                    <td><a class="btn btn-primary "href="taikhoanedit.php?id=<?php echo $item['ma_tk']; ?>">Sửa</a></td>
                                                    <td><a  class="btn btn-danger" href="taikhoandelete.php?id=<?php echo $item['ma_tk'] ?>">Xóa</a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
