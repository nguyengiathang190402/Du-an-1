                        ...
                        <div class="col-xl-12">
                            ...
                            <h5 class=""> Danh sách sản phẩm </h5>
                                <div class="card-header py-3 bg-transparent">
                                    <button class="btn btn-success pd-10"><a href="sanphamadd.php">Thêm</a></button>
                                        ...
                                        <tbody>
                                            <?php foreach ($san_pham as $item) : ?>
                                                <tr>
                                                    ...
                                                    <td><img width="100px" src="../<?php echo $item['anh'] ?>" alt=""></td>
                                                    <td><?php echo $item['gia'] ?> đ</td>
                                                    <td><a href="../chi-tiet-san-pham.php?id=<?php echo $item['ma_sp'] ?>">xem chi tiết</a></td>
                                                    ...
                                                    <td><a class="btn btn-primary"href="sanphamedit.php?id=<?php echo $item['ma_sp'] ?>">Sửa</a></td>
                                                    <td><a class="btn btn-danger"href="sanphamdelete.php?id=<?php echo $item['ma_sp'] ?>">Xóa</a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
