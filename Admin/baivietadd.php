...
if (isset($_POST['them-baiviet'])) {
   ...
   $query = "insert into bai_viet (tieu_de,mo_ta,anh_thu_nho,ngay_viet,noi_dung) values('$tieu_de','$mo_ta','$anh','$ngay_viet','$noi_dung')";
...
<body>
  ...
  <input type="text" class="form-control" placeholder="Mã bài viết" aria-label="Username" aria-describedby="basic-addon1" name="ma_bv" disabled>
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Tiêu Đề</span>
  <textarea name="tieu_de" id="" cols="100" rows="2"></textarea>
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Mô Tả Bài Viết</span>
  <textarea name="mo_ta" id="" cols="100" rows="2"></textarea>
</div>
<div class="input-group mb-3">
...
<div class="input-group mb-3">
  ...
  <input type="date" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="ngay_viet">
</div>
          </div>
          <div class="col"></div>
      </div>
  ...
  <textarea class="form-control news-write"  aria-label="With textarea" name="noi_dung" id="editor"></textarea>
            ...
            <button class="btn btn-success" name="them-baiviet">Thêm mới</button>
