                        ...
                        <div class="col-xl-12">
                            ...
                            <h5 class=""> Danh sách bài viết </h5>
                                <div class="card-header py-3 bg-transparent">
                                    <button class="btn btn-success pb-30"><a href="baivietadd.php">Thêm</a></button>
                                    ...
                                    <table class="table table-success table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($bai_viet as $item) : ?>
                                                <tr>
                                                    <td><?php echo $item['ma_bv'] ?></td>
                                                    <td><?php echo $item['tieu_de'] ?></td>
                                                    <td><?php echo $item['mo_ta'] ?></td>
                                                    <td><?php echo $item['ngay_viet'] ?></td>
                                                    <td><a href="../chi-tiet-bai-viet.php?id=<?php echo $item['ma_bv'] ?>">xem chi tiết</a></td>
                                                    <td><img width="200px" src="../<?=$item['anh_thu_nho'] ?>" alt=""></td>
                                                    <td><a class="btn btn-primary" href="baivietedit.php?id=<?php echo $item['ma_bv']; ?>">Sửa</a></td>
                                                    <td><a class="btn btn-danger"href="baivietdelete.php?id=<?php echo $item['ma_bv'] ?>">Xóa</a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
