...
$query = "insert into sanpham (ten_sp,anh,gia,mo_ta,ngay_nhap,trang_thai,ma_loai) values('$ten_sp','$anh','$gia','$mo_ta','$ngay_nhap','$trang_thai','$ma_loai')";
                ...
                <div class="container-fluid">
                    ...
                    <div class="">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control" aria-describedby="basic-addon1" type="text" name="ten_sp">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="editor" name="mo_ta" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">Giá</span>
                                        <input class="form-control" aria-describedby="basic-addon1" type="number" name="gia">
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">Ảnh</span>
                                        <input class="form-control" aria-describedby="basic-addon1" type="file" name="anh">
                                    </div>
                                    <div class="input-group mb-3">
                            ...
                            <div class="pd">
                                <button class="btn btn-success btn1" name="them-sanpham">Thêm Mới</button>
