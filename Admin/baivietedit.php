...
if (isset($_POST['btn_edit'])) {
    ...
    $mo_ta = $_POST['mo_ta'];
    $anh =$_FILES['anh_thu_nho']['name'];
    $noi_dung =$_POST['noi_dung'];
    $connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
    $query = "update bai_viet set tieu_de='$tieu_de',ngay_viet='$ngay_viet',mo_ta='$mo_ta',anh_thu_nho='$anh',noi_dung='$noi_dung' where ma_bv=$id";
...
$connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
$query = "select * from bai_viet where ma_bv=$id";
$stmt = $connection->prepare($query);
$stmt->execute();
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
          ...
          <?php foreach ($bai_viet as $item) : ?>
      <div class="row">
          <div class="col">
          <div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Mã bài viết</span>
  <input type="text" value="<?php echo $item['ma_bv'] ?>" class="form-control" placeholder="Mã bài viết" aria-label="Username" aria-describedby="basic-addon1" name="ma_bv" disabled>
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Tiêu Đề</span>
  <input type="text" value="<?php echo $item['tieu_de'] ?>" class="form-control" name="tieu_de">
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Ngày Viết</span>
  <input type="date" value="<?php echo $item['ngay_viet'] ?>" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="ngay_viet">
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Mô Tả Bài Viết</span>
  <textarea name="mo_ta" id="" cols="100" rows="2" value="<?php echo $item['mo_ta']?>"></textarea>
</div>
<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Ảnh</span>
  <input type="file" class="form-control"  aria-label="Username" aria-describedby="basic-addon1" name="anh_thu_nho">
</div>
          </div>
          <div class="col">
  ...
  <textarea class="form-control news-write" aria-label="With textarea" name="noi_dung" id="editor"></textarea>
</div>
            <button class="btn btn-primary" name="btn_edit">Sửa</button>
