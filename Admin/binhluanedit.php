...
if (isset($_POST['btn_edit'])) {
    $ma_bl = $_POST['ma_bl'];    $ten_kh = $_POST['ten_kh'];
    $ngay_bl = $_POST['ngay_bl'];
    $noi_dung = $_POST['noi_dung'];
    $ten_sp = $_POST['ten_sp'];
    $connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
    $query = "update binhluan set ten_kh='$ten_kh',ngay_bl='$ngay_bl',noi_dung='$noi_dung',ten_sp='$ten_sp' where ma_bl=$id";
...
$connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
$query = "select * from binhluan where ma_bl=$id";
$stmt = $connection->prepare($query);
$stmt->execute();
...
<body>
    ...
    <div class="col">
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="ma_bl" placeholder="mã bình luận" value="<?php echo $item['ma_bl'] ?>" >
        </div>
        <div class="">
            <div class="form-group">
                <label for="">Tên khách hàng</label>
                <input type="text" name="id" id="" value="<?php echo $id ?>" hidden>
                <input class="form-control" type="text" name="ten_kh" placeholder="Tên Loại" value="<?php echo $item['ten_kh'] ?>">
            </div>
            <div class="form-group">
                <label for="">Ngày bình luận</label>
                <input type="text" name="id" id="" value="<?php echo $id ?>" hidden>
                <input class="form-control" type="text" name="ngay_bl" placeholder="Ngày bình luận" value="<?php echo $item['ngay_bl'] ?>">
            </div>
            <div class="form-group">
                <label for="">Nội dung</label>
                <input type="text" name="id" id="" value="<?php echo $id ?>" hidden>
                <input class="form-control" type="text" name="noi_dung" placeholder="Nội dung" value="<?php echo $item['noi_dung'] ?>">
            </div>
            
            <div class="form-group">
                <label for="">Tên Sản Phẩm</label>
                <input type="text" name="id" id="" value="<?php echo $id ?>" hidden>
                <input class="form-control" type="text" name="ten_sp" placeholder="Tên Sản Phẩm" value="<?php echo $item['ten_sp'] ?>">
            </div>
            
                    <div class="form-group">
                        
                    <button style="color: blue;" name="btn_edit" class="btn btn-default">Sửa</button>
                    <button style="color: blue;" type="reset" class="btn btn-default">Nhập lại</button>
