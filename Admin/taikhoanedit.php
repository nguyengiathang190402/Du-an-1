...
if (isset($_POST['btn_edit'])) {
    ...
    $query = "update taikhoan set ten_tk='$ten_tk',mat_khau='$mat_khau',email='$email',vai_tro='$vai_tro',dia_chi='$dia_chi',anh='$anh' where ma_tk=$id";
    $stmt = $connection->prepare($query);
    $stmt->execute();
    header('location: taikhoan.php');
}
$connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
$query = "select * from taikhoan where ma_tk=$id";
$stmt = $connection->prepare($query);
$stmt->execute();
$tai_khoan = $stmt->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
<style>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="<?php echo $item['ma_tk']?>" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="ma_hh" disabled>
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">Tên Khách Hàng</span>
                                        <input type="text" value="<?php echo $item['ten_tk']?>" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="ten_tk">
                                    </div>
                                    <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Mật Khẩu</span>
                                            <input type="password" value="<?php echo $item['mat_khau']?>" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1" name="mat_khau">
                                        </div>
                                        <div class="input-group mb-3">
                                        <?php if ($item['anh'] != "") : ?>
                            <div>
                                <img src="<?= $item['anh'] ?>" width="80px">
                            </div>
                        <?php endif ?>
                                            <span class="input-group-text" id="basic-addon1">Ảnh</span>
                                            <input type="file" value="<?php echo $item['anh']?>" class="form-control" placeholder="Image" aria-label="Username" aria-describedby="basic-addon1" name="anh">
                                        </div>
                                </div>
                                <div class="col">
                                <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Email</span>
                                            <input type="email" value="<?php echo $item['email']?>" class="form-control" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" name="email">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Vai Trò</span>
                                            <input type="text" value="<?php echo $item['vai_tro']?>" class="form-control" placeholder="Role" aria-label="Username" aria-describedby="basic-addon1" name="vai_tro">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Địa chỉ</span>
                                            <input type="text" value="<?php echo $item['dia_chi']?>" class="form-control" placeholder="Address" aria-label="Username" aria-describedby="basic-addon1" name="dia_chi">
                                        </div>
                                       
                                </div>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-primary pd" name="btn_edit">Sửa</button>
