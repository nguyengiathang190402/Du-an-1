...
if (isset($_POST['btn_edit'])) {
    ...
    $query = "update sanpham set ten_sp='$ten_sp',anh='$anh',gia='$gia',mo_ta='$mo_ta',ngay_nhap='$ngay_nhap',trang_thai='$trang_thai',ma_loai='$ma_loai' where ma_sp=$id";
                        ...
                        <div class="row">
                            <form action="" method="post" enctype="multipart/form-data">
                                <?php foreach ($san_pham as $item) : ?>
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="ten_sp" value="<?php echo $item['ten_sp'] ?>">
                                            </div>
                                            <div class="input-group mb-3">
                                                <?php if ($item['anh'] != "") : ?>
                                                    <div>
                                                        <img src="<?= $item['anh'] ?>" width="50px">
                                                    </div>
                                                <?php endif ?>
                                                <span class="input-group-text" id="basic-addon1">Ảnh sản phẩm</span>
                                                <input type="file" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="anh" value="<?php echo $item['anh'] ?>">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1">Giá sản phẩm</span>
                                                <input type="number" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="gia" value="<?php echo $item['gia'] ?>">
                                            </div>
                                            <div>
                                                <span class="input-group-text">Mô tả</span>
                                                <textarea id="editor" name="mo_ta" class="form-control" value="<?php echo $item['mo_ta'] ?>"></textarea>
                                            </div>
                                        </div>
                                        <div class="col">
                                            ...
                                            <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">Ngày nhập</span>
                                        <input class="form-control" aria-describedby="basic-addon1" type="date" name="ngay_nhap" >
                                    </div>
                                            <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-primary pd" name="btn_edit" class="btn btn-default">Sửa</button>
                                    <button class="btn btn-secondary" type="reset" class="btn btn-default">Nhập lại</button>
