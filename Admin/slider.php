                        ...
                        <div class="col-xl-12">
                            ...
                            <h2 > Danh sách slider </h2>
                                <div class="card-header py-3 bg-transparent">
                                    <button class="btn btn-success btns"><a href="slideradd.php">Thêm</a></button>
                                    ...
                                    <table class="table table-success table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($slider as $item) : ?>
                                                <tr>
                                                    <td><?php echo $item['ma_slider'] ?></td>
                                                    <td><?php echo $item['ten_slider'] ?></td>
                                                    <td><img style="width: 200px;" src="<?php echo $item['anh'] ?>" alt=""></td>
                                                    <td><?php echo $item['thoi_gian'] ?></td>
                                                    <td><a class="btn btn-primary"href="slideredit.php?id=<?php echo $item['ma_slider']; ?>">Sửa</a></td>
                                                    <td><a class="btn btn-danger"href="sliderdelete.php?id=<?php echo $item['ma_slider'] ?>">Xóa</a></td>
                                                </tr>
