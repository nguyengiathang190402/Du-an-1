...
if (isset($_POST['them-taikhoan'])) {
    ...
    $query = "insert into taikhoan (ten_tk,mat_khau,email,vai_tro,dia_chi,anh) values('$ten_tk','$mat_khau','$email','$vai_tro','$dia_chi','$anh')";
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="ma_hh" disabled>
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">Tên Khách Hàng</span>
                                        <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="ten_tk">
                                    </div>
                                    <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Mật Khẩu</span>
                                            <input type="password" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1" name="mat_khau">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Ảnh</span>
                                            <input type="file" class="form-control" placeholder="Image" aria-label="Username" aria-describedby="basic-addon1" name="anh">
                                        </div>
                                </div>
                                <div class="col">
                                <div class="input-group mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Role" aria-label="Username" aria-describedby="basic-addon1" name="vai_tro">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Địa chỉ</span>
                                            <input type="text" class="form-control" placeholder="Address" aria-label="Username" aria-describedby="basic-addon1" name="dia_chi">
                                        </div>
                                       
                                </div>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-success pd" name="them-taikhoan">Thêm Mới</button>
