            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                            <h5 class=""> Danh sách loại hàng </h5>
                                <div>
                                    <button type="button" class="btn btn-success pb-30"><a href="loaihangadd.php">Thêm</a></button>
                                        ...
                                        <tbody>
                                            <?php foreach ($danh_muc as $item) : ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-primary" href="loaihangedit.php?id=<?php echo $item['ma_loai']; ?>">Sửa</a></td>
                                                    <td><a class="btn btn-danger" href="loaihangdelete.php?id=<?php echo $item['ma_loai'] ?>">Xóa</a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
