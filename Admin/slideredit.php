...
if (isset($_POST['btn_edit'])) {
    ...
    $query = "update slider set ten_slider='$ten_slider',anh='$anh',thoi_gian='$thoi_gian' where ma_slider=$id";
    $stmt = $connection->prepare($query);
    $stmt->execute();
    header('location: slider.php');
}
$connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
$query = "select * from slider where ma_slider=$id";
$stmt = $connection->prepare($query);
$stmt->execute();
...
<body>
    ...
    <?php foreach ($slider as $item) : ?>
        <div class="input-group mb-3">
                                ...
                                <input type="text" value="<?php echo $item['ma_slider'] ?>" class="form-control" placeholder="Slider ID" aria-label="Username" aria-describedby="basic-addon1" name="ma_slider">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Tên Slider</span>
                                <input type="text" value="<?php echo $item['ten_slider'] ?>" class="form-control" placeholder="Slider Name" aria-label="Username" aria-describedby="basic-addon1" name="ten_slider">
                            </div>
                            <div class="input-group mb-3">
                            <?php if ($item['anh'] != "") : ?>
                            <div>
                        ...
                        <?php endif ?>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="date" class="form-control" value="<?php echo $item['thoi_gian'] ?>" placeholder="Image" aria-label="Username" aria-describedby="basic-addon1" name="thoi_gian">
                            </div>
                            <button class="btn btn-success" name="btn_edit">Sửa</button>
