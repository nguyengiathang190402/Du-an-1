...
if (isset($_POST['btn_edit'])) {
    ...
    $query = "update danhmuc set ten_loai='$ten_loai' where ma_loai=$id";
    $stmt = $connection->prepare($query);
    $stmt->execute();
    header('location: loaihang.php');
}
$connection = new PDO("mysql:host=127.0.0.1;dbname=123;chrset=utf8", "root");
$query = "select * from danhmuc where ma_loai=$id";
$stmt = $connection->prepare($query);
$stmt->execute();
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Cập nhật loại hàng</h4>
    ...
    <div class="col">
        ...
        <span class="input-group-text" id="basic-addon1">Mã Loại</span>
            <input class="form-control" type="text" name="ma_loai" placeholder="tên loại" value="<?php echo $item['ma_loai'] ?>">
        </div>
        <div class="">
            <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Tên Loại</span>
                <input class="form-control" type="text" name="ten_loai" placeholder="Tên Loại" value="<?php echo $item['ten_loai'] ?>">
            </div>
                    <button class="btn btn-primary pl"name="btn_edit" class="btn btn-default">Sửa</button>
