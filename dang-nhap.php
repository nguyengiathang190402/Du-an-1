        ...
        <header class="mb-10">
            ...
            <div class="header_main flex justify-between py-8">
                ...
                <div class=" auth pr-20">
                    <a href="dang-nhap.php" class="mr-2 login">Đăng nhập</a>
                    <a href="dang-ky.php" class="mr-2 sign__up">Đăng ký</a>
...
<div class="form">
    <form action="xulylogin.php" class="form__auth" method="POST">
<h1>Đăng nhập</h1>
<div>
    <input type="text" name="ten_tk" placeholder="Nhập email tại đây">
</div>
<div>
    <input type="password" name="password" placeholder="Nhập mật khẩu tại đây">
</div>
<button class="btn__auth" name="btn-dangnhap"> ĐĂNG NHẬP</button>
